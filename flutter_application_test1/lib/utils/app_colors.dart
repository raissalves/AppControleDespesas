...
class AppColors {
  ...
  static const Color green = Color.fromARGB(255, 13, 168, 78);
  static const Color darkGreen = Color.fromARGB(255, 28, 103, 47);
  static const Color greenLigth = Color.fromARGB(255, 104, 218, 132);
